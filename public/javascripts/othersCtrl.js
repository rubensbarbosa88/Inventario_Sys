app.controller('othersCtrl', function ($scope, $http) {
	$scope.itens = [];
	$scope.arrayCsv = [];
	$scope.itemObj = {};
	$scope.procurar = "";
...
//getDb function
	function refresh(){
		$http.get('/outros/inventothers').success(function(data){
				$scope.itens = data;
	...
	$scope.enviar = function(form){
		$scope.submitted = true;
			if(form.$invalid){
				...
				$http.post('/outros/inventothers', $scope.itemObj).success(function(data){
					$scope.submitted = false;
					$scope.itemObj = "";
					angular.element(
...
//UPDATE A ITEM
	$scope.update = function(id, item){
		$http.put('/outros/inventothers/' + id, item).success(function(data){
			angular.element(
...
//DELETE ITEM
	$scope.delete = function(id, item){
		...
		$scope.sim = function(){
			//Delete	
			$http.delete('/outros/inventothers/' + id, item).success(function(data){
