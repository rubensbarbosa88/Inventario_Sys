...
//getDb function
	function refresh(){
		$http.get('/computadores/inventcomputers').success(function(data){
				$scope.itens = data;
	...
	$scope.enviar = function(form){
		$scope.submitted = true;
			if(form.$invalid){
				...
				$http.post('/computadores/inventcomputers', $scope.itemObj).success(function(data){
					$scope.submitted = false;
					$scope.itemObj = "";
					angular.element(
...
//UPDATE A ITEM
	$scope.update = function(id, item){
		$http.put('/computadores/inventcomputers/' + id, item).success(function(data){
			angular.element(
...
//DELETE ITEM
	$scope.delete = function(id, item){
		...
		$scope.sim = function(){
			//Delete	
			$http.delete('/computadores/inventcomputers/' + id, item).success(function(data){
